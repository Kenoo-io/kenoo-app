    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="sm" className="h-6 w-6 p-0 hover:bg-transparent shadow-none group">
          <span className="flex items-center justify-center p-1 rounded-full transition-all duration-300 ease-in-out text-neutral-500 group-hover:bg-neutral-100 group-hover:text-neutral-800">
