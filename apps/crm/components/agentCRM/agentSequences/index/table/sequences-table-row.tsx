      ...
      <Card className="w-full rounded-none bg-gray-50 backdrop-blur-md border-b border-r border-l-0 border-t-0 border-neutral-300 transition-all duration-300 group relative overflow-visible box-border">
        <CardContent className="py-3 relative z-10">
          <div className="flex items-stretch">
            ...
            <div
              className="flex items-stretch gap-4 flex-shrink-0 sticky left-0 z-10 pr-0 overflow-visible bg-gray-50"
              style={{ width: `${columnWidths.name}px` }}
            >
              <div
                onClick={() => onSequenceClick(sequence.id)}
                className="flex items-center gap-4 flex-1 cursor-pointer transition-all duration-200 -my-3 py-3 pl-6 relative bg-gray-50 hover:bg-gray-200/60 max-w-full self-stretch min-h-full"
              >
