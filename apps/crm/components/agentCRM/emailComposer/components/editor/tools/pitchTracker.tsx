      ...
      >
        ...
        <div className="overflow-y-auto flex-1 bg-white/80 backdrop-blur-xl">
          ...
          <div>
            ...
            >
              <span className="text-sm font-light text-gray-700">Managed</span>
              ...
              {expandedManaged && (
                ...
                >
                  {displayManagedCreators.length === 0 ? (
                    <div className="py-2 px-4 text-sm font-light text-gray-500">No managed creators found</div>
                  ) : (
              ...
              {expandedAll && (
                ...
                >
                  {displayAllCreators.length === 0 ? (
                    <div className="py-2 px-4 text-sm font-light text-gray-500">No creators found</div>
                  ) : (
