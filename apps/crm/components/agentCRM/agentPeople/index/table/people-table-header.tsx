    ...
    <Card className="w-full rounded-none rounded-tl-lg bg-gray-50 border-b border-r border-l-0 border-t-0 border-neutral-300 sticky top-0 z-40 overflow-hidden">
      ...
      <CardContent className="py-2 relative bg-gray-50">
        <div className="flex items-stretch">
          {/* Sticky Left Section - Name & Company Header */}
          <div
          ...
          >
            <div className="flex items-center min-w-max pl-0" style={{ gap: '0.5rem' }}>
              <div className="flex items-center flex-shrink-0 pl-6 relative" style={{ width: `${columnWidths.company}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 pl-3 truncate">Company</span>
                <ResizeHandle column="company" />
              </div>
              <div className="flex items-center gap-2 flex-shrink-0 relative" style={{ width: `${columnWidths.actions}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 truncate">Actions</span>
                <ResizeHandle column="actions" />
              </div>
              <div className="flex items-center flex-shrink-0 relative" style={{ width: `${columnWidths.location}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 truncate">Location</span>
                <ResizeHandle column="location" />
              </div>
              <div className="flex items-center flex-shrink-0 relative" style={{ width: `${columnWidths.title}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 truncate">Title</span>
                <ResizeHandle column="title" />
              </div>
              <div className="flex items-center gap-2 flex-shrink-0 relative" style={{ width: `${columnWidths.phone}px` }}>
              ...
              <div className="flex items-center flex-shrink-0 relative" style={{ width: `${columnWidths.department}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 truncate">Department</span>
                <ResizeHandle column="department" />
              </div>
              <div className="flex items-center flex-shrink-0 relative" style={{ width: `${columnWidths.source}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 truncate">Source</span>
                <ResizeHandle column="source" />
              </div>
              <div className="flex items-center flex-shrink-0 relative" style={{ width: `${columnWidths.status}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 truncate">Status</span>
              ...
              <div className="flex items-center flex-shrink-0 relative" style={{ width: `${columnWidths.lastContacted}px` }}>
                <span className="text-[11px] font-normal uppercase tracking-[0.16em] text-neutral-500 truncate">Last Contacted</span>
                <ResizeHandle column="lastContacted" />
              </div>
