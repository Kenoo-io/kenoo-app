...
interface PeopleTableToolbarProps {
  ...
  onFilterToggle: () => void;
  /** Ref attached to the + button so the create-person dropdown can ignore clicks on it for "click outside" close. */
  createButtonRef?: React.RefObject<HTMLButtonElement | null>;
  /** Called when + is clicked. Passes the click event so parent can position a dropdown under the button. */
    ...
    <div className="flex-shrink-0 w-full mt-4 pl-8 pr-0">
      <div className="flex justify-between items-end mb-6 gap-4">
        <div className="flex items-center gap-4 flex-1">
          ...
          {/* Search Bar - styled like analytics search */}
