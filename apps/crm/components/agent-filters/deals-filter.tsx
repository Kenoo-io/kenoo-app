        ...
        <ScrollArea className="flex-1 px-6 py-4">
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                <SelectTrigger className="border border-transparent bg-transparent rounded-full focus:ring-0 focus-visible:ring-0 px-4 [&>svg]:hidden hover:bg-neutral-100 transition-all duration-300 ease-in-out">
