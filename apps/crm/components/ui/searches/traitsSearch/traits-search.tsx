          ...
          {showAddPanel ? (
            ...
            >
              <input
                ...
                className="w-full rounded-none border-0 border-b border-neutral-200 bg-transparent py-2 text-sm font-light placeholder:text-neutral-300 focus:border-b-[var(--walls-sky)] focus:outline-none"
              />
              ...
              <div className="flex items-center justify-end gap-3 pt-1">
                ...
                <button
                  type="button"
                  className="text-[10px] font-light lowercase tracking-wide text-[var(--walls-sky)] hover:underline disabled:opacity-50"
                  disabled={adding}
